    ...
    public class BuiltInSerializerTests
    {
        ...
        public void InternalSerializableTypesHaveSerializers()
        {
            ...
            var grainReferenceType = typeof(IRemindable).Assembly.GetType(
                ...
                throwOnError: true);
            Assert.True(
                environment.Serializer.CanSerialize(grainReferenceType),
...
#pragma warning restore xUnit2017 // Do not use Contains() to check if a value exists in a collection
        ...
        public void ISerializable_CallbackOrder_Class()
        {
            ...
            var result = (SimpleISerializableObject)OrleansSerializationLoop(environment.Serializer, environment.DeepCopier,  input);
            Assert.Equal(
                new[]
                {
                    "default_ctor",
        ...
        public void ISerializable_CallbackOrder_Struct()
        {
            ...
            // Verify that our behavior conforms to our expected behavior.
            var result = (SimpleISerializableStruct)OrleansSerializationLoop(environment.Serializer, environment.DeepCopier,  input);
            Assert.Equal(
                new[]
                {
                    "serialization_ctor",
