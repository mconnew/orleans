    ...
    internal class LibraryTypes
    {
        ...
        public static LibraryTypes FromCompilation(Compilation compilation, CodeGeneratorOptions options)
        {
            return new LibraryTypes
            {
                ...
                ApplicationPartAttribute = Type("Orleans.Serialization.ApplicationPartAttribute"),
                ...
                GenerateMethodSerializersAttribute = Type("Orleans.Serialization.GenerateMethodSerializersAttribute"),
                GenerateSerializerAttribute = Type("Orleans.Serialization.GenerateSerializerAttribute"),
                SerializationCallbacksAttribute = Type("Orleans.Serialization.SerializationCallbacksAttribute"),
                ...
                WellKnownAliasAttribute = Type("Orleans.Serialization.WellKnownAliasAttribute"), 
                WellKnownIdAttribute = Type("Orleans.Serialization.WellKnownIdAttribute"), 
                IInvokable = Type("Orleans.Serialization.Invocation.IInvokable"),
                DefaultInvokeMethodNameAttribute = Type("Orleans.Serialization.DefaultInvokeMethodNameAttribute"),
                InvokeMethodNameAttribute = Type("Orleans.Serialization.InvokeMethodNameAttribute"),
                InvokableCustomInitializerAttribute = Type("Orleans.Serialization.InvokableCustomInitializerAttribute"),
                DefaultInvokableBaseTypeAttribute = Type("Orleans.Serialization.DefaultInvokableBaseTypeAttribute"),
                InvokableBaseTypeAttribute = Type("Orleans.Serialization.InvokableBaseTypeAttribute"),
                FromServiceProviderAttribute = Type("Orleans.Serialization.FromServiceProviderAttribute"),
                RegisterSerializerAttribute = Type("Orleans.Serialization.RegisterSerializerAttribute"),
                RegisterActivatorAttribute = Type("Orleans.Serialization.RegisterActivatorAttribute"),
                RegisterCopierAttribute = Type("Orleans.Serialization.RegisterCopierAttribute"),
                UseActivatorAttribute = Type("Orleans.Serialization.UseActivatorAttribute"),
                SuppressReferenceTrackingAttribute = Type("Orleans.Serialization.SuppressReferenceTrackingAttribute"),
                OmitDefaultMemberValuesAttribute = Type("Orleans.Serialization.OmitDefaultMemberValuesAttribute"),
