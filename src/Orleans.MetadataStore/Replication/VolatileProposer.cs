...
{
    public class VolatileProposer<TValue> : IProposer<TValue>, VolatileProposer<TValue>.ITestAccessor
    {
        ...
        public VolatileProposer(string key, Ballot initialBallot, Func<ExpandedReplicaSetConfiguration> getConfiguration, ILogger log)
        {
        ...
        internal Ballot Ballot { get => _ballot; set => _ballot = value; }

        Ballot ITestAccessor.Ballot { get => _ballot; set => _ballot = value; }
