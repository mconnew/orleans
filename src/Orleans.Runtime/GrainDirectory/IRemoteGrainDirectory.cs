...
namespace Orleans.Runtime
{
    ...
    /// </summary>
    internal interface IRemoteDhtGrainDirectory : ISystemTarget, IDhtGrainDirectory
    {        
        /// <summary>
        ...
        Task<List<ActivationAddress>> LookUpMany(List<(GrainId GrainId, string ETag)> grainAndETagList);
        ...
        /// </summary>
        /// <param name="activations">The activation registrations from the split partition.</param>
        /// <returns></returns>
        Task AcceptSplitPartition(List<ActivationAddress> activations);
    }
}
