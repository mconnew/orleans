...
namespace Orleans.Runtime
{
    internal class Catalog : SystemTarget, ICatalog, IPlacementRuntime, IHealthCheckParticipant
    {
            ...
            : base(Constants.CatalogType, messageCenter.MyAddress, loggerFactory)
        {
            ...
            this.ActivationMessagePump = new ActivationMessagePump(this, grainInterfaceVersions, messagingTrace, activationCollector, scheduler, compatibilityDirectorManager);
            this.Dispatcher = new Dispatcher(
                this.ActivationMessagePump,
                scheduler,
                messageCenter,
                this,
                messagingOptions,
                ...
                activationDirectory,
                messagingTrace);
            this.ActivationMessagePump.SetDispatcher(this.Dispatcher);
        ...
        public ActivationMessagePump ActivationMessagePump { get; }
