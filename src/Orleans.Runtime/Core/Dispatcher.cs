...
namespace Orleans.Runtime
{
    internal class Dispatcher
    {
        ...
        private readonly ActivationMessagePump activationMessagePump;
        ...
        {
            this.activationMessagePump = activationMessagePump;
            ...
            bool rejectMessages = false)
        {
            ...
            if (oldAddress != null)
            {
                var localGrainDirectory = this.RuntimeClient.ServiceProvider.GetRequiredService<ILocalGrainDirectory>();
