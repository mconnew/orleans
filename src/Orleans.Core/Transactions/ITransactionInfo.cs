...
namespace Orleans.Transactions
{
    ...
    public interface ITransactionInfo
    {
        ...
        /// <param name="serializer">The serialization manager used for serializing the exception</param>
        void RecordException(Exception e, Hagar.Serializer serializer);

        /// <summary>
        /// Check if this transaction must abort. 
        /// </summary>
        /// <param name="serializer">The serialization manager used for deserializing the exception</param>
        /// <returns>returns an exception object if the transaction must abort, or null otherwise</returns>
        OrleansTransactionAbortedException MustAbort(Hagar.Serializer serializer);
