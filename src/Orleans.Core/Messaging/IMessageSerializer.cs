...
using Orleans.GeneratedCodeHelpers;
using Orleans.Serializers;
using Orleans.Session;
...
namespace Orleans.Runtime.Messaging
{
    ...
    internal class HagarMessageSerializer : IMessageSerializer
    {
            ...
            int maxBodySize)
        {
            ...
            _requestContextCodec = HagarGeneratedCodeHelper.GetService<DictionaryCodec<string, object>>(this, codecProvider);
        }
        ...
        public void WriteRequestContext<TBufferWriter>(ref Writer<TBufferWriter> writer, Dictionary<string, object> value) where TBufferWriter : IBufferWriter<byte>
        {
            ...
            foreach (var entry in value)
            {
                ...
                _serializer.Serialize<object, TBufferWriter>(entry.Value, ref writer);
            }
        }
