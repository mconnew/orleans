...
namespace Orleans.Runtime
{
    ...
    internal class DetailedGrainReport
    {
        ...
        public ActivationAddress LocalCacheGrainAddress { get; set; }
        /// <summary>activation addresses in the local directory.</summary>
        public ActivationAddress LocalDirectoryGrainAddress { get; set; }
        ...
        public override string ToString()
        {
            return string.Format(Environment.NewLine
                ...
                + "   LocalCacheActivationAddress={3}" + Environment.NewLine
                + "   LocalDirectoryActivationAddress={4}" + Environment.NewLine
