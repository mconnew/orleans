...
namespace Orleans.Networking.Shared
{
    ...
    {
#if !NETCOREAPP
        private static readonly WaitCallback Callback = state => ((IOQueue)state).Execute();
#endif
...
#else
                System.Threading.ThreadPool.UnsafeQueueUserWorkItem(Callback, this);
#endif
            }
        }
        ...
        public void Execute()
        {
            while (true)
            {
                ...
                // If work wasn't already scheduled, continue loop.
            }
        }
