...
namespace Orleans.Runtime
{
    ...
    /// </summary>
    internal struct CheapStopwatch
    {
        private long _value;
        ...
        public static CheapStopwatch StartNew() => new CheapStopwatch(GetTimestamp());
        
        private CheapStopwatch(long timestamp)
        {
            _value = timestamp;
        }
        ...
        /// <summary>
        /// Returns a new, stopped <see cref="CheapStopwatch"/> with the provided start and end timestamps.
        /// </summary>
        /// <param name="start">The start timestamp.</param>
        /// <param name="end">The end timestamp.</param>
        /// <returns>A new, stopped <see cref="CheapStopwatch"/> with the provided start and end timestamps.</returns>
        public static CheapStopwatch FromTimestamp(long start, long end) => new CheapStopwatch(-(end - start));
